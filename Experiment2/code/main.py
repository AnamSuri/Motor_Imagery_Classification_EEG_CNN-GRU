''''
Author: Anam Suri
This is the main code file for experiment 2
We designed this experiment to check the performance with gradually increasng the training data
Here we are training with merged session 1 and 2 and so on, finally testing with session 5
The user can change the path of the session when experimenting with the different sessions (1, 2, 3 and 4)
